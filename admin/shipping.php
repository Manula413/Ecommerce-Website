...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset ($_POST['update_shipping'])) {
    ...
    if (!$update_shipping->execute([$shipping_status, $tracker, $order_id])) {
        echo "Execute failed: (" . $update_shipping->errorCode() . ") " . $update_shipping->errorInfo();
    } else {
                ...
                <tbody>
                    <?php foreach ($orders as $order): ?>
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <select name="shipping_status" class="form-select status-select">
                                        <option value="to_be_shipped" <?= ($order['shipping_status'] === 'to_be_shipped') ? 'selected' : ''; ?>>To be
                                            shipped</option>
                            ...
                            <td>
                                <input type="text" name="tracker" class="form-control"
                                    value="<?= isset ($order['tracker']) ? $order['tracker'] : ''; ?>">
                            </td>
                            <td>
