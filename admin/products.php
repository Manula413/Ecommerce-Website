...
if (isset ($_POST['add_product'])) {
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, baseprice, quantity, image_01, image_02, image_03, category) VALUES(?,?,?,?,?,?,?,?,?)");
         ...
         <div class="flex">
            <div class="inputBox">
               ...
               <select required name="cat" id="cat" class="box" placeholder="enter product category">
                  <option value="">..............................................................</option>
                  <option value="facewash">Beverages</option>
                  <option value="cream">Cooking Essentials</option>
                  <option value="hairoil">Dairy</option>
                  <option value="lipstic">Food Cupboard</option>
                  <option value="nailpolish">Frozen Food</option>
